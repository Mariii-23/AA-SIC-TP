...
public class CompanyDAO {
	...
	public static Company loadCompanyByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Company) session.load(Company.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Company getCompanyByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Company) session.get(Company.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Company loadCompanyByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Company) session.load(Company.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Company getCompanyByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Company) session.get(Company.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(Company company) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().saveObject(company);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Company company) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().deleteObject(company);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Company company) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().getSession().refresh(company);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Company company) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().getSession().evict(company);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
