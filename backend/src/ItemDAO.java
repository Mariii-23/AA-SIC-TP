...
public class ItemDAO {
	...
	public static Item loadItemByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Item) session.load(Item.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item getItemByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Item) session.get(Item.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item loadItemByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Item) session.load(Item.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item getItemByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Item) session.get(Item.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryItem(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Item as Item");
		if (condition != null)
	...
	public static boolean save(Item item) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().saveObject(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Item item) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().deleteObject(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Item item) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().getSession().refresh(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Item item) throws PersistentException {
		try {
			AAeSICTPPersistentManager.instance().getSession().evict(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
