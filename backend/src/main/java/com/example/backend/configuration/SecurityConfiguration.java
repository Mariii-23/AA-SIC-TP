    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/auth/**", "product/all/**", "info/all/**", "/db/**", "/customer/password/**", "/admin/password/**", "/product/category/numberOfProducts", "/product/subcategory/numberOfProducts").permitAll()
